...
class _NotificationsPageState extends State<NotificationsPage> {
  ...
  {
    QuerySnapshot querySnapshot=await activityFeedReference.document(currentUser.id).collection("feedItems").orderBy("timestamp",descending: true)
...
class NotificationsItem extends StatelessWidget {
  ...
  configureMediaPreview(context)
  {
    ...
    {
      notificationItemText=" followed you.";
    }
    else
      {
