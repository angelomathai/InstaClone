...
class _ProfilePageState extends State<ProfilePage> {
  ...
  createButton()
  {
    bool ownProfile=currentOnlineUserId==widget.userProfileId? true:false;
    if(ownProfile)
      {
      ...
      child: FlatButton(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border:  Border.all(color: following?Colors.grey:Colors.blue),
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text("No posts",style: TextStyle(color: Colors.grey,fontWeight: FontWeight.bold,fontSize: 40.0),),
              ),
            ],
          ),
        );
  ...
  createListAndGridPostOrientation()
  {
    return Row(
      ...
      children: <Widget>[
        IconButton(
          onPressed: ()=>serOrientation("grid"),
          icon: Icon(Icons.grid_on),
          color: postOrientation=="grid"? Theme.of(context).primaryColor:Colors.grey,
        ),
        IconButton(
          onPressed: ()=>serOrientation("list"),
  ...
  serOrientation(String orientation)
  {
    setState(() {
